...
export default {
  ...
  watch: {
    '$store.state.file.currEditFile': {
      handler(val) {
        this.currFile = _clonedeep(val)
      },
      immediate: true,
    },
  },
  ...
  methods: {
    onCloseDrawer() {
      this.$store.commit('file/SET_FILE_DRAWER_STATUS', false)
    },
  },
}
</script>
