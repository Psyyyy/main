...
export default {
  ...
  methods: {
    ...
    initConfig() {
    //   this.editor.config.uploadFileName = this.uploadFileName ? this.uploadFileName : 'image[]'
    //   this.editor.config.uploadImgServer = this.uploadImgServer
    //   this.editor.config.uploadImgShowBase64 = this.uploadImgShowBase64 ? this.uploadImgShowBase64 : false
      ...
      if (this.menus !== undefined && this.menus instanceof Array && this.menus.length) {
        ...
        // 禁用菜单
        this.editor.config.menus = this.filterDisabledMenu(this.editor.config.menus, this.disabledMenus)
      } else {
