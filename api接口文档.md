    ...
    "users": [
      {
        ...
        "create_time": "2017-11-09T20:36:26.000Z", //加入项目时间
...
```json
{
  "data": {
    "id": 566,
    "rid": 0 / 1 / 2, //用户角色0是超级管理
    "username": "admin",
    "mobile": "123456",
    "email": "bb@itcast.com",
    "mg_state": 0 //用户登陆状态，0为未登录
  },
  "meta": {
    "msg": "设置状态成功",
    "status": 200
